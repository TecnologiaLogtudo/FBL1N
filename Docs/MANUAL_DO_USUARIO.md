...
Antes de executar, escolha o modo no controle de topo da tela:
...
| **Resumo Aberto** | (Modo inverso) mostra totais por transportadora para os títulos fornecidos |
| **Aberto vs Pago** | (Modo inverso) lista cada CTRC aberto com o status do FBL1 |
